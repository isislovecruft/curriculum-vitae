...
\MyName{isis osiris agora lovecruft}
...
clientele have included The Tor Project, Signal Foundation, Zcash, 
...
\WorkEntry{Applied Cryptographer}{2019 -- present}
 {Private Clientele, Consultant/Contractor}{Cryptographic protocol
   ...
   speed improvements on some hardware. Consulted and worked with a client
   who is shipping my Dalek Cryptography libraries to billions of users.
   Experience included working with and optimising the outputs of
   several systems for formal methods, including fiat-crypto and cryptol.}
\sepspace

\WorkEntry{Applied Cryptographer}{2018 -- 2020}
 {Meta}{Elliptic curve signature and zero-knowledge proof security,
   including both production implementations and formal proofs.}
\sepspace
...
\WorkEntry{Applied Cryptographer}{2016 -- present} {Dalek Cryptography,
  ...
  fastest cryptographic library, \textsc{curve25519-dalek}, including
  designing and prototyping the Ristretto prime-order group for use in
  practical, real-world sigma protocols. See
  \href{https://github.com/dalek-cryptography}{the Dalek Cryptography Github
    organisation} and \href{https://ristretto.group}{our documentation on the
    Ristretto design}. Significant effort was also put into writing two sets of
  extensive documentation for \textsc{curve25519-dalek}, one
  \href{https://doc.dalek.rs}{aimed at security engineers} with light to moderate
  experience in cryptographic engineering, and the other
  \href{https://doc-internal.dalek.rs}{aimed at fellow mathematicians and cryptographers}.}
\sepspace
...
\WorkEntry{Dalek Cryptography}{2018 -- present}{Mentor}{Assisted several high
  school through university students in writing their first patches to various
  Dalek Cryptography libraries.}
\sepspace
...
\WorkEntry{!!Con West}{2020}{University of California, Santa Cruz}{Keynote
  presentation on implementing supersingular isogeny key encapsulation over a
  434-bit finite field in handwritten 6510 assembly, including ``illegal''
  opcodes, for a commodore 64.}
\sepspace
...
%%% Industry Impacts
\NewPart{Industry Impacts}{}
\SkillsEntry{International Industry \mbox{Standards}}{
  Co-author of the IETF Ristretto Document \\
  Co-author of the IETF draft on threshold signatures
}
...
\SkillsEntry{Languages}{\textsc{Rust}, \textsc{C/C++},
  ...
  \textsc{Go}, \textsc{x86/ARM/MIPS/6510 ASMs}, \textsc{Common Lisp}, \textsc{Bash}, \textsc{Lua},
...
\SkillsEntry{Software}{Low- to High-Level Cryptographic Design, Cryptographic Engineering,
  ...
  Misuse-Resistant API Design, Security Best Practices, Reverse Engineering}
