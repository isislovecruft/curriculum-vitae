...
\WorkEntry{Applied Cryptographer}{2019 - present}
 {Private Clientele, Consultant/Contractor}{Cryptographic protocol
   ...
   speed improvements on some hardware. Experience included working
   with and optimising the outputs of several systems for formal
   methods, including fiat-crypto and cryptol.}
\sepspace
